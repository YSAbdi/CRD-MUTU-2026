...
Route::prefix('v1')->middleware('throttle:api')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::get('dashboard',DashboardController::class); Route::get('calendar',[CalendarController::class,'index']);
        ...
        Route::middleware('role:superadmin')->group(function () { Route::get('users',[UserController::class,'index']); Route::post('users',[UserController::class,'store']); Route::put('users/{user}',[UserController::class,'update']); Route::delete('users/{user}',[UserController::class,'destroy']); });
    });
});
